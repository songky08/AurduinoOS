/*
 *    Extended system control API implementation for TC2x
 */
...
static void system_set_pll(const PPllInitValue pPllInitValue)
{
  ...
  pSCU->PLLCON0.U |= ((1 << IFX_SCU_PLLCON0_VCOBYP_OFF)
      | (1 << IFX_SCU_PLLCON0_SETFINDIS_OFF));
...
unsigned int SYSTEM_GetCoreId(void)
{
